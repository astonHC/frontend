...
bool FRONTEND_BASE::INIT(int argc, char** argv)
{
	...
	/* ASSUMING SOMETHING GOES WRONG IN THE INITIALISATION PHASE, USE SDL METHODS FOR STDERR */
	...
	else
	{
		...
		WINDOW_BASE->SET_TITLEBAR_COLOUR();

		if (WINDOW_BASE->WINDOW_WIDTH == FRONTEND_DEFAULT_WIDTH && WINDOW_BASE->WINDOW_HEIGHT == FRONTEND_DEFAULT_HEIGHT)
		{
			SDL_SetWindowSize(WINDOW_BASE->GET_WINDOW(), FRONTEND_DEFAULT_WIDTH, FRONTEND_DEFAULT_HEIGHT);
		}
